<script lang="ts">
	...
	const variants = {
		...
		tableCreateAction:
			'bg-blue-500 text-blue-950 hover:bg-blue-600 flex flex-row p-2 float-right align-top shadow',
		formSubmit:
			'bg-blue-500 text-blue-950 hover:bg-blue-600 shadow min-w-24 text-center justify-center items-center flex flex-row'
	};
	const sizes = {
		icon: 'p-2',
		sm: 'px-4 py-2',
